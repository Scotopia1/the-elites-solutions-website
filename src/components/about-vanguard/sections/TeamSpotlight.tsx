...
const teamMembers = [
  {
    id: 1,
    name: "Johnny Jneid",
    role: "Co-founder & Marketing Innovator",
    quote: "Innovation is the bridge between vision and market reality.",
    initials: "JJ",
    bio: "Driving The Elites' marketing strategy and innovation initiatives. Johnny transforms market insights into compelling brand narratives that resonate with audiences and fuel business growth through creative marketing excellence.",
  ...
  },
  {
    ...
    initials: "CT",
    bio: "Architecting robust software solutions and engineering excellence at The Elites. Charbel builds scalable, high-performance systems that power digital experiences, combining technical mastery with innovative problem-solving.",
    social: ["LinkedIn", "Instagram"],
  },
  {
    id: 3,
    name: "Joe Jneid",
    role: "Co-founder & Design AI Specialist",
    quote: "Design meets intelligence—where creativity and AI converge.",
    initials: "JN",
    bio: "Leading design innovation and AI-powered creative solutions at The Elites. Joe blends cutting-edge AI tools with design expertise to craft intelligent, beautiful experiences that push creative boundaries.",
    social: ["LinkedIn", "Instagram"],
  },
  {
    id: 4,
    name: "Anthony Gemayel",
    role: "Sales & Client Success Lead",
    quote: "Success is built on trust, delivered through partnership.",
    initials: "AG",
    bio: "Championing client relationships and driving business growth through strategic partnerships. Anthony transforms client visions into successful collaborations, ensuring sustainable growth and exceptional results.",
    social: ["LinkedIn", "Instagram"],
  },
];
